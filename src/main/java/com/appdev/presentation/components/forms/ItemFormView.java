...
public class ItemFormView extends JScrollPane {
    ...
    private void init(LostItem item) {
        ...
        panel.add(new DescriptionLabel("Where do you think you might have lost the item: ", item.getLocationDetails()), "gapy 5 0");
        panel.add(new DescriptionLabel("When do you think you might have lost the item: ", item.getDateTimeLost().format(DateTimeFormatter.ofPattern("MMMM d, yyyy hh:mm a"))));
    ...
    private void init(FoundItem item) {
        ...
        panel.add(new DescriptionLabel("Item Subtype: ", item.getItemSubtype()), "gapy 5 0");
        panel.add(new DescriptionLabel("Item Description: ", item.getItemDescription()), "gapy 5 0");
        panel.add(new DescriptionLabel("Where do did you find the item: ", item.getLocationDetails()), "gapy 5 0");
        panel.add(new DescriptionLabel("When did you find the item: ", item.getDateTimeFound().format(DateTimeFormatter.ofPattern("MMMM d, yyyy hh:mm a"))));
        panel.add(new DescriptionLabel("Item Photo: ", ""), "gapy 5 0");
        panel.add(new JLabel(item.getImageIcon(350, 350, 0)), "gapy 0 10");
